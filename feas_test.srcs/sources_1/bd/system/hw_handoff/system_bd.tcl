...
CONFIG.NUM_SI {3} \
  ...
  # Create instance: dummysquare_0, and set properties
  set dummysquare_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:dummysquare:1.0 dummysquare_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins dummysquare_0/S00_AXIS]
  set_property -dict [ list \
...
HDL_ATTRIBUTE.DEBUG_IN_BD {true} \
  ...
  connect_bd_intf_net -intf_net dummysquare_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins dummysquare_0/M00_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
HDL_ATTRIBUTE.DEBUG_IN_BD {true} \
 ] [get_bd_intf_nets dummysquare_0_M00_AXIS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins dummysquare_0/m00_axis_aclk] [get_bd_pins dummysquare_0/s00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins dummysquare_0/m00_axis_aresetn] [get_bd_pins dummysquare_0/s00_axis_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
...
preplace inst axi_dma_0 -pg 1 -lvl 3 -y 200 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 530 -defaultsOSRD
preplace inst dummysquare_0 -pg 1 -lvl 2 -y 170 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 50 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 270 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 570 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 580 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 680
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 370 450 NJ 450 NJ 450 NJ 450 1860
preplace netloc dummysquare_0_M00_AXIS 1 2 1 670
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 720 NJ 720 NJ 720 NJ 720 NJ 720 1850
preplace netloc axi_dma_0_M_AXI_SG 1 3 1 1110
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1410
preplace netloc axi_dma_0_s2mm_introut 1 3 1 1080
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 340 350 700 330 1090
...
preplace netloc axi_dma_0_mm2s_introut 1 3 1 1070
preplace netloc axi_dma_0_M_AXI_S2MM 1 3 1 N
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 360 340 NJ 340 1110
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 440 350 260 690 320 1100 580 1430 710 1860
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 3 340 80 NJ 80 1060
levelinfo -pg 1 0 180 520 880 1260 1640 1880 -top 0 -bot 730
",
}
